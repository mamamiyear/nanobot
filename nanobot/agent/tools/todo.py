...
class TodoTool(Tool):
    ...
    def __init__(self, base_dir: Path = None):
        self._base_dir = base_dir or get_config_path().parent
        self._db_path = self._base_dir / "todo" / "db" / "todos.db"
        self._init_db()
    ...
    def description(self) -> str:
        return """Built-in tool to manage a todo list for task tracking.
Operations:
